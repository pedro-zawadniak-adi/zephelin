...
// tvm target: c -keys=arm_cpu,cpu -device=arm_cpu -march=armv7e-m -mcpu=cortex-m7
// -model=stm32f746xx
#define TVM_EXPORTS
...
#endif
	TVM_DLL int32_t
	tvmgen_default_fused_nn_batch_flatten(void *args, int32_t *arg_type_ids, int32_t num_args,
...
#endif
	TVM_DLL int32_t
	tvmgen_default_fused_nn_conv2d_add_nn_relu(void *args, int32_t *arg_type_ids,
...
#endif
	TVM_DLL int32_t
	tvmgen_default_fused_nn_conv2d_add_nn_relu_1(void *args, int32_t *arg_type_ids,
						     int32_t num_args, void *out_ret_value,
						     int32_t *out_ret_tcode, void *resource_handle);
#ifdef __cplusplus
extern "C"
#endif
	TVM_DLL int32_t
	tvmgen_default_fused_nn_dense_add(void *args, int32_t *arg_type_ids, int32_t num_args,
					  void *out_ret_value, int32_t *out_ret_tcode,
					  void *resource_handle);
#ifdef __cplusplus
extern "C"
#endif
	TVM_DLL int32_t
	tvmgen_default_fused_nn_dense_add_nn_relu(void *args, int32_t *arg_type_ids,
						  int32_t num_args, void *out_ret_value,
						  int32_t *out_ret_tcode, void *resource_handle);
#ifdef __cplusplus
extern "C"
#endif
	TVM_DLL int32_t
	tvmgen_default_fused_nn_max_pool2d(void *args, int32_t *arg_type_ids, int32_t num_args,
					   void *out_ret_value, int32_t *out_ret_tcode,
					   void *resource_handle);
#ifdef __cplusplus
extern "C"
#endif
	TVM_DLL int32_t
	tvmgen_default_fused_nn_max_pool2d_1(void *args, int32_t *arg_type_ids, int32_t num_args,
					     void *out_ret_value, int32_t *out_ret_tcode,
					     void *resource_handle);
#ifdef __cplusplus
extern "C"
#endif
	TVM_DLL int32_t
	tvmgen_default_fused_nn_softmax(void *args, int32_t *arg_type_ids, int32_t num_args,
					void *out_ret_value, int32_t *out_ret_tcode,
					void *resource_handle);
#ifdef __cplusplus
extern "C"
					      ...
					      void *resource_handle)
{
	...
	void *tvmgen_default_fused_nn_batch_flatten_tensor_strides =
		(((DLTensor *)tensor)[0].strides);
						   ...
						   int32_t *out_ret_tcode, void *resource_handle)
{
	...
	void *tvmgen_default_fused_nn_conv2d_add_nn_relu_T_relu_strides =
		(((DLTensor *)T_relu)[0].strides);
	...
	for (int32_t ax0_ax1_outer_fused = 0; ax0_ax1_outer_fused < 128; ++ax0_ax1_outer_fused) {
		...
		for (int32_t ax2_outer = 0; ax2_outer < 3; ++ax2_outer) {
			for (int32_t i1 = 0; i1 < 4; ++i1) {
				for (int32_t i2 = 0; i2 < 3; ++i2) {
					...
					PadInput[(cse_var_1 + i2)] =
						(((((1 <= cse_var_3) && (cse_var_3 < 129)) &&
						   (1 <= cse_var_2)) &&
						  (cse_var_2 < 4))
							 ? ((float *)p0_1)[(
								   (((cse_var_1 +
								      (ax0_ax1_outer_fused * 3)) +
								     i2) +
								    ax2_outer) -
								   4)]
							 : 0.000000e+00f);
			...
			for (int32_t ax3_inner = 0; ax3_inner < 8; ++ax3_inner) {
				...
				((float *)
					 T_relu_1)[(((ax0_ax1_outer_fused * 24) + (ax2_outer * 8)) +
						    ax3_inner)] =
						     ...
						     int32_t *out_ret_tcode, void *resource_handle)
{
	...
	void *T_relu = (((TVMValue *)args)[3].v_handle);
	void *p0_1 = (((DLTensor *)p0)[0].data);
	void *tvmgen_default_fused_nn_conv2d_add_nn_relu_1_p0_strides =
		(((DLTensor *)p0)[0].strides);
	void *p1_1 = (((DLTensor *)p1)[0].data);
	void *tvmgen_default_fused_nn_conv2d_add_nn_relu_1_p1_strides =
		(((DLTensor *)p1)[0].strides);
	void *p2_1 = (((DLTensor *)p2)[0].data);
	void *tvmgen_default_fused_nn_conv2d_add_nn_relu_1_p2_strides =
		(((DLTensor *)p2)[0].strides);
	void *T_relu_1 = (((DLTensor *)T_relu)[0].data);
	void *tvmgen_default_fused_nn_conv2d_add_nn_relu_1_T_relu_strides =
		(((DLTensor *)T_relu)[0].strides);
	...
	for (int32_t ax0_ax1_outer_fused = 0; ax0_ax1_outer_fused < 42; ++ax0_ax1_outer_fused) {
			...
			for (int32_t i3 = 0; i3 < 8; ++i3) {
				...
				PadInput[(cse_var_1 + i3)] =
					(((1 <= cse_var_2) && (cse_var_2 < 43))
						 ? ((float *)p0_1)[(((cse_var_1 +
								      (ax0_ax1_outer_fused * 8)) +
								     i3) -
								    8)]
						 : 0.000000e+00f);
			}
		...
		for (int32_t ax3_outer = 0; ax3_outer < 2; ++ax3_outer) {
			for (int32_t ax3_inner = 0; ax3_inner < 8; ++ax3_inner) {
				...
				((float *)T_relu_1)[(((ax0_ax1_outer_fused * 16) + cse_var_6) +
						     ax3_inner)] =
					((v_) > (0.000000e+00f) ? (v_) : (0.000000e+00f));
			}
		}
					  ...
					  void *resource_handle)
{
	...
	for (int32_t k_outer = 0; k_outer < 16; ++k_outer) {
		for (int32_t x_c = 0; x_c < 4; ++x_c) {
			compute_global[x_c] =
				(compute_global[x_c] +
				 (((float *)p0_1)[k_outer] * packed_weight[((k_outer * 4) + x_c)]));
		}
	}
	for (int32_t ax1_inner_inner = 0; ax1_inner_inner < 4; ++ax1_inner_inner) {
		((float *)T_add_1)[ax1_inner_inner] =
			(compute_global[ax1_inner_inner] + ((float *)p2_1)[ax1_inner_inner]);
	}
	return 0;
}
						  ...
						  int32_t *out_ret_tcode, void *resource_handle)
{
	...
	void *T_relu_1 = (((DLTensor *)T_relu)[0].data);
	void *tvmgen_default_fused_nn_dense_add_nn_relu_T_relu_strides =
		(((DLTensor *)T_relu)[0].strides);
	...
	for (int32_t z = 0; z < 2; ++z) {
		for (int32_t y = 0; y < 224; ++y) {
			for (int32_t x = 0; x < 8; ++x) {
				...
				((float *)packed_weight)[((cse_var_1 + (y * 8)) + x)] =
					((float *)p1_1)[((cse_var_1 + (x * 224)) + y)];
			}
		}
	}
			...
			for (int32_t x_c = 0; x_c < 8; ++x_c) {
				compute_global[x_c] =
					(compute_global[x_c] +
					 (((float *)p0_1)[k_outer] *
					  ((float *)packed_weight)[(
						  ((ax1_outer_ax0_outer_fused * 1792) +
						   (k_outer * 8)) +
						  x_c)]));
			}
		}
					   ...
					   void *resource_handle)
{
	...
	void *tvmgen_default_fused_nn_max_pool2d_pool_max_strides =
		(((DLTensor *)pool_max)[0].strides);
		...
		for (int32_t ax3 = 0; ax3 < 8; ++ax3) {
			...
			for (int32_t rv0 = 0; rv0 < 3; ++rv0) {
				for (int32_t rv1 = 0; rv1 < 3; ++rv1) {
					...
					float v__1 = ((float *)p0_1)[(
						(((ax1 * 72) + (rv0 * 24)) + (rv1 * 8)) + ax3)];
					((float *)pool_max_1)[cse_var_1] =
						((v_) > (v__1) ? (v_) : (v__1));
				}
			}
		}
					     ...
					     void *resource_handle)
{
	...
	void *pool_max_1 = (((DLTensor *)pool_max)[0].data);
	void *tvmgen_default_fused_nn_max_pool2d_1_pool_max_strides =
		(((DLTensor *)pool_max)[0].strides);
					...
					void *resource_handle)
{
	...
	void *tvmgen_default_fused_nn_softmax_T_softmax_norm_strides =
		(((DLTensor *)T_softmax_norm)[0].strides);
